...
def get_KS_params_grid():
    grid = dict(
        # Th=[[12, 10], [12, 9], [10, 8], [10, 7], [8, 6], [8, 5], [6, 4]],
        # Th=(7 * [[10, 2]])
        # Th=[[5, 3], [5, 2], [4, 3], [4, 2], [3, 2], [3, 1], [2, 1], [1, 0.5]],
        # Th=[[8, 4], [8, 2], [6, 4], [6, 2], [4, 2], [4, 1], [2, 1]],
        # Th=[[7, 4], [7, 3], [7, 2], [6, 4], [6, 3], [5, 4], [5, 3]],
        Th=[[6, 2], [5, 2], [4, 2], [3, 1], [2, 1], [1, 0.5], [0.5, 0.25]],
